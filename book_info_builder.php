...
{
    echo "INSERT INTO `books_info` (`hadithbd_book_id`, `book_name`, `book_type`, `book_category_id`, `book_sort_priority`, `current_version`, `meta_data`) VALUES ('".$row['hadithbd_id']."', '".$row['book_name']."', '".$row['book_type']."', ".$row['book_category_id'].", ".$row['sort_priority'].", '".$row['book_version']."', '".$row['meta_data']."');";
